...
function ProductoEdit(){
    ...
    return (
        <div className="card shadow position-top-box">
            ...
            <br/>
            <form className="productoBox" action={`/api/products/edit/${Producto.id}?_method=PUT`} method="POST" encType="multipart/form-data" id="formulario">
                <span>Nombre del producto: </span> 
                <br/>
                <input type="text" name= "title" className="input-producto" placeholder={Producto.title}/>
                <br/>
                <span>Descripcion del producto: </span>
                <br/>
                <textarea className="input-producto" rows= "10" cols="50" name= "description" placeholder={Producto.description}></textarea>
                <br/>
                <span>Modelo: </span>
                <br/>
                <input type="text" name="model" className="input-producto" placeholder={Producto.model}/>                                                  
                <br/>
                <span>Imagen: </span>
                <br/>
                ...
                <span>Precio: </span>
                <br/>
                <input type="text" name="price" className="input-producto" placeholder={Producto.price}/>                                                  
                <br/>
